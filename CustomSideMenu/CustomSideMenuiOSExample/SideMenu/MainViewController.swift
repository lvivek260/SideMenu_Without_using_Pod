...
//    }
    ...
    override func viewDidLoad() {
      ...
      //  self.setNavBarAppearance(tintColor: .white, barColor: .gray)
       ...
       // showViewController(viewController: UINavigationController.self, storyboardId: "HomeNavID")
        showViewController(viewController: UITabBarController.self, storyboardId: "TapBarId")
    }
    ...
    func selectedCell(_ row: Int) {
        ...
        case 1:
           ...
           // self.showViewController(viewController: UINavigationController.self, storyboardId: "MusicNavID")
            let nextViewController = self.storyboard?.instantiateViewController(withIdentifier: "MusicViewController") as! MusicViewController
            self.navigationController?.pushViewController(nextViewController, animated: true)
           // self.present(nextViewController, animated:true, completion:nil)
           // self.showViewController(viewController: UIViewController.self, storyboardId: "MusicViewController")
            break
        case 2:
            // Movies
            break
